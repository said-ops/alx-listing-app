...
function Header() {
  return (
    <header className="font-quicksand font-semibold text-[16px] ">
      {/* more info  */}
      <div className="w-full text-white  bg-primaryColor  flex justify-center items-center p-4 gap-4 max-h-[47px]">
        <svg
          width="34"
          height="34"
          viewBox="0 0 34 34"
        ...
        <Button text="More info" bgColor="bg-seconadyColor" textColor="text-white" height="30px"></Button>
      </div>
    </header>
  );
}
